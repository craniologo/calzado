...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<h2><i class="fa fa-exchange"></i> Traspaso entre Inventarios</h2>
		  				...
		  				<div class="box-body table-responsive">
							<table class="table table-bordered table-hover">
								<thead>
									...
									<th style="text-align: center; width: 40px;">Precio&nbsp;<?php echo $currency; ?></th>
									<th style="text-align: center; width: 40px;">Total&nbsp;<?php echo $currency; ?></th>
								...
								<tr>
									...
									<td><b><?php  $pt = $product->price_in*$p["q"]; $total +=$pt; echo $currency.' '.number_format($pt,2,".",","); ?></b></td>
					...
					<div class="col-md-4 col-md-offset-7">
						<div class="box box-primary">
							<table class="table table-bordered">
								<tr>
									<td><p>Subtotal</p></td>
									<td><p><b><?php echo $currency; ?><?php echo number_format($total*(1 - ($iva_val/100) ),2,'.',','); ?></b></p></td>
								</tr>
								<tr>
									<td><p><?php echo $iva_name." (".$iva_val."%) ";?></p></td>
									<td><p><b><?php echo $currency; ?><?php echo number_format($total*($iva_val/100),2,'.',','); ?></b></p></td>
								</tr>
								<tr>
									<td><p>Total</p></td>
									<td><p><b><?php echo $currency; ?><?php echo number_format($total,2,'.',','); ?></b></p></td>
								</tr>
							</table>
						</div>
					  	<div class="form-group">
