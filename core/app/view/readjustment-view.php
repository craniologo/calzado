<section class="content">
	...
	<div class="row">
		...
		<?php $products = ProductData::getLike($_GET["readjust"]);
		if(count($products)>0){ ?>
		...
		<div class="col-md-12">
			<form method="post" class="form-horizontal" id="processsell" action="index.php?action=readj_process">
				<div class="form-group">
					<?php $asset = SellData::getAllByLastReadj();
			        $num = 1;
				...
				<div class="form-group">
				    <div class="col-lg-offset-6 col-lg-12">
				      <div class="checkbox">
				        ...
				        <button class="btn btn-primary"><i class="fa fa-refresh"></i> Procesar Reajuste</button>
