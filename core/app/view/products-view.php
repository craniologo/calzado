<section class="content"> <!-- Main content -->
	...
	<div class="row">
		<div class="col-md-12">
            ...
            <a href="index.php?view=product_new" class="col-md-1 btn btn-default"><i class='fa fa-tag'></i> Nuevo Producto</a>
			<br><br>
			<?php if ($u->kind) {
				...
				$prods = ProductData::getAll();
				/*$prods = ProductData::getAllByListIdAll($_SESSION["user_id"]);*/
			}
			if(count($prods)>0){ ?> <!-- si hay usuarios -->
			<div class="box">
		  				...
		  				<div class="box-body table-responsive">
							<table class="table table-bordered datatable table-hover">
								...
								<tr>
									...
									<td style="text-align: center"><?php if($prd->image!=""):?><img src="storage/products/<?php echo $prd->image;?>" style="width:64px;"><?php endif;?></td>
