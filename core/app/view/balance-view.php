...
<?php // foreach($operations as $operation):?>
	<tr>
		...
		<td>S/ <?php echo number_format($operations[0]->t,2,'.',','); ?></td>
		<td>S/ <?php echo number_format($res[0]->tot,2,'.',','); ?></td>
		<td>S/ <?php echo number_format($spends[0]->t,2,'.',','); ?></td>
		<td>S/ <?php echo number_format($operations[0]->t-($spends[0]->t+$res[0]->tot),2,'.',','); ?></td>
	</tr>
<?php
$restotal+= ($res[0]->tot);
...
<div class="jumbotron">
	...
	<tr>
		<td>Total</td>
		<td>S/ <?php echo number_format($selltotal,2,'.',','); ?></td>
		<td>S/ <?php echo number_format($restotal,2,'.',','); ?></td>
		<td>S/ <?php echo number_format($spendtotal,2,'.',','); ?></td>
		<td>S/ <?php echo number_format($selltotal-($spendtotal+$restotal),2,'.',','); ?></td>
	</tr>
</table>
</div>
<?php else:?>
